...
_DEFAULT_FULL_LANG_CODES = {'af': 'af-za',
                            'am': 'am-et',
                            'ar': 'ar-sa',  # Is this a good default?
                            'az': 'az-az',
                            'bg': 'bg-bg',
                            'bn': 'bn-bd',
                            'bs': 'bs-ba',
                            ...
                            'su': 'su-id',
                            'sv': 'sv-se',
                            'sw': 'sw-ke',  # Is this a good default?
                            'ta': 'ta-in',  # Is this a good default?
                            'te': 'te-in',
                            'th': 'th-th',
                            'tr': 'tr-tr',
                            'uk': 'uk-ua',
                            'ur': 'ur-in',  # Is this a good default?
                            'uz': 'uz-uz',
                            'vi': 'vi-vn',
                            'zh': 'zh-cn',  # Sometimes defined as cmn-cn?
                            'zu': 'zu-za'
                            }
