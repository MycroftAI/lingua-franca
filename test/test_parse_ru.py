...
class TestNormalize(unittest.TestCase):
    ...
    def test_extractdatetime_ru(self):
        ...
        #             "2017-06-27 14:04:00", "")
        # testExtract("хочу это через час",
        #             "2017-06-27 14:04:00", "хочу это")
        ...
        testExtract("напомнить мне встать через 4 года",
                    "2021-06-27 00:00:00", "напомнить мне встать")
        testExtract("напомнить мне встать через 4 года и 4 дня",
                    "2021-07-01 00:00:00", "напомнить мне встать")
        ...
        # testExtract("поставь будильник на среду в 3 часа в полдень",
        ...
        testExtract("я пообедал вчера в 6",
                    "2017-06-26 06:00:00", "я пообедал")
        testExtract("я пообедал вчера в 6 am",
                    "2017-06-26 06:00:00", "я пообедал")
